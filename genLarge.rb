...
batchSize.times { |j|
	...
	loop do
		...
		break if countloc(code) >= 130 && code.length <= maxsize
	end
	...
	puts `timeout 600 java -jar "/home/user/Documents/Uni/Bachelor Thesis/crowbar-tool/build/libs/crowbar-0.1-all.jar" --method="MockABS.Generated.gen" --investigate #{filepath}`
